...
map.getView().fit([8876533.170002, 862288.063327, 9584259.570287, 1326957.484833], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">practicle 1</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (67 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows the transportation routes and waterways in sri lanka';
            }
